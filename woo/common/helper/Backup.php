...
class Backup
{
    ...
    private $config = array(
        ...
        'level' => 1 //数据库备份文件压缩级别 1普通 4 一般  9最高
    );
    ...
    {
        $this->config['path'] = root_path() . DIRECTORY_SEPARATOR . 'data' . DIRECTORY_SEPARATOR . 'backup' . DIRECTORY_SEPARATOR;
        $this->config = array_merge($this->config, $config);
        //初始化文件名
        $this->setFile();
        $this->dbconfig = get_db_config();
        //检查文件是否可写
