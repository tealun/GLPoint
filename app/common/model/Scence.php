...
/**
 * 自动生成的模型文件2021-03-22 23:26:52，不建议在当前文件中手动写代码；以免重新生成以后被覆盖。
 * 自定义代码应用定义在模型对应的trait文件中【app\common\model\traits\ScenceTrait】
 */
...
class Scence extends App
{
	use traits\ScenceTrait;
