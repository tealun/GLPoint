...
/**
 * 自动生成的模型文件2021-10-24 01:54:58，不建议在当前文件中手动写代码；以免重新生成以后被覆盖。
 * 自定义代码应用定义在模型对应的trait文件中【app\common\model\traits\DeniedTrait】
 */
...
class Denied extends App
{
	use traits\DeniedTrait;
		...
		*/
		$this->form = [
			...
			'expire' => [
				...
				'message' => '为空即长时间限制登录，用户重置密码以后自动解除；也可以禁用账号来永久禁用',
			],
			'is_verify' => [
				'type' => 'integer',
				'name' => '是否执行',
