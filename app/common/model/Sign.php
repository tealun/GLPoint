...
/**
 * 自动生成的模型文件2021-11-10 11:33:22，不建议在当前文件中手动写代码；以免重新生成以后被覆盖。
 * 自定义代码应用定义在模型对应的trait文件中【app\common\model\traits\SignTrait】
 */
...
class Sign extends \woo\common\model\Sign
{
	use traits\SignTrait;
		...
		*/
		...
		$this->validate = [
			'date' => [
				...
				[
					'rule' => ['unique', 'sign,user_id^date'],
					'message' => '该日期已签到',
				],
				[
					'rule' => ['call', 'checkToday'],
				],
			],
			'user_id' => [
				[
