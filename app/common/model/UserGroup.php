...
/**
 * 自动生成的模型文件2023-04-05 17:34:28，不建议在当前文件中手动写代码；以免重新生成以后被覆盖。
 * 自定义代码应用定义在模型对应的trait文件中【app\common\model\traits\UserGroupTrait】
 */
...
class UserGroup extends \woo\common\model\UserGroup
{
	use traits\UserGroupTrait;

	/** 模型ID */
	protected $modelId = 18;
