...
/**
 * 自动生成的模型文件2021-05-22 20:57:41，不建议在当前文件中手动写代码；以免重新生成以后被覆盖。
 * 自定义代码应用定义在模型对应的trait文件中【app\common\model\traits\RegionTrait】
 */
...
class Region extends \woo\common\model\Region
{
	use traits\RegionTrait;
		...
		*/
		$this->form = [
			...
			'pinyin' => [
				...
				'is_contribute' => false,
				'attrs' => [
					'placeholder' => '如为空，系统会自动识别；格式：beijing',
				],
			],
			'jianpin' => [
				'type' => 'string',
