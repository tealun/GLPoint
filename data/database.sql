...
(327, 0, '积分', 1, 3, ',327,', 1, 6, 1740643417, 1740643606, 'directory', 'woo-icon-jifen', '', '', '', '', '', '_iframe', 'jf', 'jifen', '', '', ''),
...
(359, 327, '积分看板', 1, 0, ',327,359,', 2, 0, 1746081593, 1746081593, 'menu', 'layui-icon-chart-screen', '', 'user_score', 'dashboard', '', '', '_iframe', 'jfkb', 'jifenkanban', 'user_score/dashboard', '', ''),
(360, 327, '积分排名', 1, 2, ',327,360,', 2, 0, 1738761600, 1738761600, 'menu', 'layui-icon-chart', '', 'user_score', 'ranking', '', '', '_iframe', 'jfpm', 'jifenpaiming', 'user_score/ranking', '', ''),
